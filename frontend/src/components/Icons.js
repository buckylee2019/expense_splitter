...
// Flaticon-style SVG icons for mobile navigation
...
export const GroupIcon = ({ size = 24, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} xmlns="http://www.w3.org/2000/svg">
    <path d="M16 4c0-1.11.89-2 2-2s2 .89 2 2-.89 2-2 2-2-.89-2-2zM4 18v-4.5c0-1.1.9-2 2-2s2 .9 2 2V18h8v-7.5c0-.83-.67-1.5-1.5-1.5S13 9.67 13 10.5V12h-2v-1.5c0-1.93 1.57-3.5 3.5-3.5s3.5 1.57 3.5 3.5V18h2v2H2v-2h2zm2-13.5c0 1.38 1.12 2.5 2.5 2.5S11 5.88 11 4.5 9.88 2 8.5 2 6 3.12 6 4.5z"/>
  </svg>
);
